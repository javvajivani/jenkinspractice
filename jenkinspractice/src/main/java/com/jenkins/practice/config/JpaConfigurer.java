package com.jenkins.practice.config;
...
import com.jenkins.practice.support.jpa.CustomRepositoryFactoryBean;
import com.jenkins.practice.support.jpa.SpringSecurityAuditorAware;
import com.jenkins.practice.web.entity.User;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.jenkins.practice.web.repository", repositoryFactoryBeanClass = CustomRepositoryFactoryBean.class)
// @EnableJpaRepositories(basePackages =
// "com.jenkins.practice.web.repository",
